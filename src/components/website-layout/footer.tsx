...
const Footer = () => {
  ...
  return (
    <footer>
      <div className="dark:bg-neutral-900 bg-neutral-800 text-white py-10 border-t">
          ...
          <div className="grid grid-cols-6 gap-8 w-full">
            ...
            <div className="lg:col-span-2 md:col-span-3 col-span-6">
              <div className="flex flex-col md:items-start items-center gap-y-2 md:text-start text-center">
                ...
                <div className="md:w-4/5">{t("description")}</div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 md:col-span-3 col-span-6">
              <div className="flex flex-col md:items-start items-center gap-y-3">
                <div className="font-semibold text-lg">{t("help.title")}</div>
            ...
            <div className="lg:col-span-2 md:col-span-3 col-span-6">
              <div className="flex flex-col md:items-start items-center gap-y-3">
                ...
                <ul className="flex flex-col md:items-start items-center gap-y-2">
                  <li>
                    <a href="#">{t("reservations.publish")}</a>
                  </li>
                  <li>
                    <a href="#">{t("reservations.find")}</a>
                  </li>
                </ul>
                ...
                <div className="flex gap-x-2 px-3 py-1 rounded-lg bg-neutral-700">
                  {buttons.map((btn) => (
                    <button
                      ...
                      className={`p-2 rounded-full hover:bg-green-700/70 transition-colors ${
                        theme === btn.id ? "bg-green-700/70" : " "
                      }`}
                    >
                      {btn.icon}
                    </button>
            ...
            <div className="col-span-6">
              <div className="flex flex-col gap-y-5 justify-center items-center">
                ...
                <div className="flex text-center">{t("rights")}</div>
              </div>
            </div>
          </div>
        </div>
